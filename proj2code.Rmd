...
gg1_NDAI <- ggplot() +
  geom_boxplot(aes(x = factor(image1$label), y = image1$NDAI)) +
  xlab("Label") +
  ylab("NDAI") +
  ggtitle("label vs NDAI") +
  theme_bw()
gg1_SD <- ggplot() +
  geom_boxplot(aes(x = factor(image1$label), y = image1$SD)) +
  xlab("Label") +
  ylab("SD") +
  ggtitle("label vs SD") +
  theme_bw()
gg1_CORR <- ggplot() +
  geom_boxplot(aes(x = factor(image1$label), y = image1$CORR)) +
  xlab("Label") +
  ylab("CORR") +
  ggtitle("label vs CORR") +
  theme_bw()
gg2_NDAI <- ggplot() +
  geom_boxplot(aes(x = factor(image2$label), y = image2$NDAI)) +
  xlab("Label") +
  ylab("NDAI") +
  ggtitle("label vs NDAI") +
  theme_bw()
gg2_SD <- ggplot() +
  geom_boxplot(aes(x = factor(image2$label), y = image2$SD)) +
  xlab("Label") +
  ylab("SD") +
  ggtitle("label vs SD") +
  theme_bw()
gg2_CORR <- ggplot() +
  geom_boxplot(aes(x = factor(image2$label), y = image2$CORR)) +
  xlab("Label") +
  ylab("CORR") +
  ggtitle("label vs CORR") +
  theme_bw()
gg3_NDAI <- ggplot() +
  geom_boxplot(aes(x = factor(image3$label), y = image3$NDAI)) +
  xlab("Label") +
  ylab("NDAI") +
  ggtitle("label vs NDAI") +
  theme_bw()
gg3_SD <- ggplot() +
  geom_boxplot(aes(x = factor(image3$label), y = image3$SD)) +
  xlab("Label") +
  ylab("SD") +
  ggtitle("label vs SD") +
  theme_bw()
gg3_CORR <- ggplot() +
  geom_boxplot(aes(x = factor(image3$label), y = image3$CORR)) +
  xlab("Label") +
  ylab("CORR") +
  ggtitle("label vs CORR") +
  theme_bw()
...
# >>>>>>> e65e987ad462edf6837af7b253069e149569e5a0
...
# index_knn1 <- which.min(abs(roc_knn1$sensitivities - roc_knn1$specificities)[-1])
# plot(roc_knn1, print.thres = roc_knn1$thresholds[index_knn1], col = "red", 
#      asp = NA, legacy.axes = TRUE, main = "ROC of KNN")
plot(roc_knn1,  legacy.axes = TRUE, asp = NA, main = "ROC of KNN")

roc_tree1 <- roc(test_set1$label, prob_tree1, auc = TRUE)
# index_tree1 <- which.min(abs(roc_tree1$sensitivities - roc_tree1$specificities)[-1])
# plot(roc_tree1, print.thres = roc_tree1$thresholds[index_tree1], col = "red",
#      asp = NA, legacy.axes = TRUE, main = "ROC of Tree")
plot(roc_tree1,  legacy.axes = TRUE, asp = NA, main = "ROC of Tree")
...
plot(roc_logis2, col = "red", asp = NA, legacy.axes = TRUE, main = "ROC of LDA")

roc_qda2 <- roc(test_set2$label, prob_qda2, auc = TRUE)
plot(roc_qda2,  legacy.axes = TRUE, asp = NA, main = "ROC of QDA")

roc_knn2 <- roc(test_set2$label, prob_knn2, auc = TRUE)
plot(roc_knn2,  legacy.axes = TRUE, asp = NA, main = "ROC of KNN")

roc_tree2 <- roc(test_set2$label, prob_tree2, auc = TRUE)
plot(roc_tree2,  legacy.axes = TRUE, asp = NA, main = "ROC of Tree")

roc_rf2 <- roc(test_set2$label, prob_rf2, auc = TRUE)
plot(roc_rf2,  legacy.axes = TRUE, asp = NA, main = "ROC of Random Forest")
...
```{r}
agreement1 <- 1 - precision_split1
rownames(agreement1)[nrow(agreement1)] <- "average"
agreement2 <- 1 - precision_split2
rownames(agreement2)[nrow(agreement2)] <- "average"
agreement1
agreement2
```
...
>>>>>>> e473a55cd188bb4cb85825252ed9a2d2d4edab94
...
```{r}
agreement1 <- 1 - recall_split1
rownames(agreement1)[nrow(agreement1)] <- "average"
agreement2 <- 1 - recall_split2
rownames(agreement2)[nrow(agreement2)] <- "average"
agreement1
agreement2
```
...
yhat_logis1_i1 <- predict(logistic_model1, helper11[[4]], type = "response")
yhat_logis1_i2 <- predict(logistic_model1, helper12[[4]], type = "response")
yhat_logis1_i3 <- predict(logistic_model1, helper13[[4]], type = "response")

yhat_logis2_i1 <- predict(logistic_model2, helper1[[4]], type = "response")
yhat_logis2_i2 <- predict(logistic_model2, helper2[[4]], type = "response")
yhat_logis2_i3 <- predict(logistic_model2, helper3[[4]], type = "response")

1 - (length(misindex_logis1_i1) + length(misindex_logis1_i2) + length(misindex_logis1_i3))/30227

misindex_logis1_i1 <- which(as.numeric(yhat_logis1_i1 > 0.5) != (as.numeric(helper11[[4]]$label)+1)/2)
misindex_logis1_i2 <- which(as.numeric(yhat_logis1_i2 > 0.5) != (as.numeric(helper12[[4]]$label)+1)/2)
misindex_logis1_i3 <- which(as.numeric(yhat_logis1_i3 > 0.5) != (as.numeric(helper13[[4]]$label)+1)/2)

misindex_logis2_i1 <- which(as.numeric(yhat_logis2_i1 > 0.5) != (as.numeric(helper1[[4]]$label)+1)/2)
misindex_logis2_i2 <- which(as.numeric(yhat_logis2_i2 > 0.5) != (as.numeric(helper2[[4]]$label)+1)/2)
misindex_logis2_i3 <- which(as.numeric(yhat_logis2_i3 > 0.5) != (as.numeric(helper3[[4]]$label)+1)/2)


ggplot() + 
  geom_raster(aes(x = helper11[[4]]$x, y = helper11[[4]]$y)) +
  geom_point(aes(x = helper11[[4]]$x[misindex_logis1_i1], y = helper11[[4]]$y[misindex_logis1_i1],
                 shape = factor(helper11[[4]]$label[misindex_logis1_i1])), size= 0.6, color = "#BCBDDC") +
  scale_color_manual(values=(brewer.pal(9, "Purples"))) + theme_bw() + 
  ggtitle("Split1 of Image1: Misclassification of Logistics") +
  xlab("x") +
  ylab("y")
ggplot() + 
  geom_raster(aes(x = helper12[[4]]$x, y = helper12[[4]]$y)) +
  geom_point(aes(x = helper12[[4]]$x[misindex_logis1_i2], y = helper12[[4]]$y[misindex_logis1_i2],
                 shape = factor(helper12[[4]]$label[misindex_logis1_i2])), size= 0.6, color = "#BCBDDC") +
  scale_color_manual(values=(brewer.pal(9, "Purples"))) + theme_bw() + 
  ggtitle("Split1 of Image2: Misclassification of Logistics") +
  xlab("x") +
  ylab("y")
ggplot() + 
  geom_raster(aes(x = helper13[[4]]$x, y = helper13[[4]]$y)) +
  geom_point(aes(x = helper13[[4]]$x[misindex_logis1_i3], y = helper13[[4]]$y[misindex_logis1_i3],
                 shape = factor(helper13[[4]]$label[misindex_logis1_i3])), size= 0.6, color = "#BCBDDC") +
  scale_color_manual(values=(brewer.pal(9, "Purples"))) + theme_bw() + 
  ggtitle("Split1 of Image3: Misclassification of Logistics") +
  xlab("x") +
  ylab("y")

ggplot() + 
  geom_raster(aes(x = helper1[[4]]$x, y = helper1[[4]]$y)) +
  geom_point(aes(x = helper1[[4]]$x[misindex_logis2_i1], y = helper1[[4]]$y[misindex_logis2_i1],
                 shape = factor(helper1[[4]]$label[misindex_logis2_i1])), size= 0.6, color = "#BCBDDC") +
  scale_color_manual(values=(brewer.pal(9, "Purples"))) + theme_bw() + 
  ggtitle("Split2 of Image1: Misclassification of Logistics") +
  xlab("x") +
  ylab("y")
ggplot() + 
  geom_raster(aes(x = helper2[[4]]$x, y = helper2[[4]]$y)) +
  geom_point(aes(x = helper2[[4]]$x[misindex_logis2_i2], y = helper2[[4]]$y[misindex_logis2_i2],
                 shape = factor(helper2[[4]]$label[misindex_logis2_i2])), size= 0.6, color = "#BCBDDC") +
  scale_color_manual(values=(brewer.pal(9, "Purples"))) + theme_bw() + 
  ggtitle("Split2 of Image2: Misclassification of Logistics") +
  xlab("x") +
  ylab("y")
ggplot() + 
  geom_raster(aes(x = helper3[[4]]$x, y = helper3[[4]]$y)) +
  geom_point(aes(x = helper3[[4]]$x[misindex_logis2_i3], y = helper3[[4]]$y[misindex_logis2_i3],
                 shape = factor(helper3[[4]]$label[misindex_logis2_i3])), size= 0.6, color = "#BCBDDC") +
  scale_color_manual(values=(brewer.pal(9, "Purples"))) + theme_bw() + 
  ggtitle("Split2 of Image3: Misclassification of Logistics") +
  xlab("x") +
  ylab("y")

# feature
gg1_NDAI_mis <- gg1_NDAI + 
  geom_point(aes(x = factor(helper11[[4]]$label[misindex_logis1_i1]), y = helper11[[4]]$NDAI[misindex_logis1_i1]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper1[[4]]$label[misindex_logis2_i1]), y = helper1[[4]]$NDAI[misindex_logis2_i1]),
             color = "blue", shape = 4, alpha = 0.7)

gg1_SD_mis <- gg1_SD + 
  geom_point(aes(x = factor(helper11[[4]]$label[misindex_logis1_i1]), y = helper11[[4]]$SD[misindex_logis1_i1]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper1[[4]]$label[misindex_logis2_i1]), y = helper1[[4]]$SD[misindex_logis2_i1]),
             color = "blue", shape = 4, alpha = 0.7)

gg1_CORR_mis <- gg1_CORR + 
  geom_point(aes(x = factor(helper11[[4]]$label[misindex_logis1_i1]), y = helper11[[4]]$CORR[misindex_logis1_i1]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper1[[4]]$label[misindex_logis2_i1]), y = helper1[[4]]$CORR[misindex_logis2_i1]),
             color = "blue", shape = 4, alpha = 0.7)

gg2_NDAI_mis <- gg2_NDAI + 
  geom_point(aes(x = factor(helper12[[4]]$label[misindex_logis1_i2]), y = helper12[[4]]$NDAI[misindex_logis1_i2]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper2[[4]]$label[misindex_logis2_i2]), y = helper2[[4]]$NDAI[misindex_logis2_i2]),
             color = "blue", shape = 4, alpha = 0.7)

gg2_SD_mis <- gg2_SD + 
  geom_point(aes(x = factor(helper12[[4]]$label[misindex_logis1_i2]), y = helper12[[4]]$SD[misindex_logis1_i2]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper2[[4]]$label[misindex_logis2_i2]), y = helper2[[4]]$SD[misindex_logis2_i2]),
             color = "blue", shape = 4, alpha = 0.7)

gg2_CORR_mis <- gg2_CORR + 
  geom_point(aes(x = factor(helper12[[4]]$label[misindex_logis1_i2]), y = helper12[[4]]$CORR[misindex_logis1_i2]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper2[[4]]$label[misindex_logis2_i2]), y = helper2[[4]]$CORR[misindex_logis2_i2]),
             color = "blue", shape = 4, alpha = 0.7)

gg3_NDAI_mis <- gg3_NDAI + 
  geom_point(aes(x = factor(helper13[[4]]$label[misindex_logis1_i3]), y = helper13[[4]]$NDAI[misindex_logis1_i3]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper3[[4]]$label[misindex_logis2_i3]), y = helper3[[4]]$NDAI[misindex_logis2_i3]),
             color = "blue", shape = 4, alpha = 0.7)

gg3_SD_mis <- gg3_SD + 
  geom_point(aes(x = factor(helper13[[4]]$label[misindex_logis1_i3]), y = helper13[[4]]$SD[misindex_logis1_i3]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper3[[4]]$label[misindex_logis2_i3]), y = helper3[[4]]$SD[misindex_logis2_i3]),
             color = "blue", shape = 4, alpha = 0.7)

gg3_CORR_mis <- gg3_CORR + 
  geom_point(aes(x = factor(helper13[[4]]$label[misindex_logis1_i3]), y = helper13[[4]]$CORR[misindex_logis1_i3]),
             color = "red", shape = 3, alpha = 0.5) +
  geom_point(aes(x = factor(helper3[[4]]$label[misindex_logis2_i3]), y = helper3[[4]]$CORR[misindex_logis2_i3]),
             color = "blue", shape = 4, alpha = 0.7)

jpeg("misclass_feature.jpeg")
