...
# classification tree
err_tree2 <- CVgeneric("tree", train_val_set2[,c(4,5,6)], train_val_set2$label, lossfn = loss)
err_tree2

# random forest
err_rf2 <- CVgeneric("randomforest", train_val_set2[,c(4,5,6)], train_val_set2$label, lossfn = loss)
err_rf2
